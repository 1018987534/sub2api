export default {
  ...
  keys: {
    ...
    groupRoutesLabel: 'Group routing',
    groupRoutesHint: 'Try available groups in primary-to-backup order.',
    groupRoutesEmpty: 'Select a primary group to configure ordered fallback groups.',
    primaryGroup: 'Primary',
    backupGroup: 'Backup {index}',
    backupShort: 'backup',
    addBackupGroup: 'Add backup',
    removeBackupGroup: 'Remove backup group',
    moveBackupUp: 'Move backup up',
    moveBackupDown: 'Move backup down',
    maxMultiplier: 'Maximum multiplier',
    maxAcceptedMultiplier: 'Highest accepted multiplier',
    unlimitedMultiplier: 'No limit',
    maxMultiplierHint: 'Enter the highest effective multiplier this key accepts (for example, 0.20x). Leave it empty for no cap. A group above the cap is skipped and the next backup is tried.',
    invalidGroupRoutes: 'Each group route must have a positive group and multiplier cap.',
    statusLabel: 'Status',
    ...
    manageGroupRoutes: 'Manage ordered group routing',
    manageGroupRoutesTitle: 'Manage group routing',
    manageGroupRoutesFor: 'Only change the primary group, multiplier caps, and backup order for “{name}”.',
    groupRoutesUpdatedSuccess: 'Group routing updated',
    manage: 'Manage',
