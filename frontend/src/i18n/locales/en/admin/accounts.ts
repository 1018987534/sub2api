export default {
    accounts: {
      ...
      columns: {
        ...
        upstreamBillingRate: 'Upstream Billing Rate',
        weight: 'Weight',
      ...
      upstreamBilling: {
        trustWarning: 'This column shows the upstream billing rate used locally. When a conversion ratio is configured, the declaration is converted before profit control, low-rate scheduling, sorting, and account-cost calculation use it. Sub2API cannot verify the declaration against actual upstream billing; verify it against bills, balance changes, and actual usage.',
        ...
        rateConversionRatioInvalid: 'The upstream rate conversion ratio must be greater than 0 and no more than 100.',
        syncedRateTooltip: 'The account rate and scheduler upstream rate are synchronized from the converted declaration',
        manualProbe: 'Probe upstream rate now',
        stale: 'Stale',
        unsupported: 'Unsupported',
        failed: 'Failed',
        notProbed: 'Not probed',
        conversionSummary: 'Conversion: declared {declared}x × {ratio} = local base {converted}x',
      ...
      tempUnschedulable: {
        ...
        hint: 'Configure when upstream failures temporarily remove an account from scheduling.',
        notice: 'Rules are evaluated in order and require both error code and keyword match.',
        modeRules: 'By Error Rule',
        modeConsecutiveFailures: 'By Consecutive Failures',
        modeFirstTokenLatency: 'By First-Token Latency Share',
        failureNotice: 'Every failed call updates all rules; one success resets them. If multiple rules trigger, the longest pause wins.',
        addRule: 'Add Rule',
        addFailureRule: 'Add Failure Rule',
        ...
        failureRulesInvalid: 'Add at least one valid failure rule; window, count, and pause are required positive integers.',
        ...
        consecutiveFailureSummary: '{count}/{threshold} consecutive failures within {window} seconds',
        firstTokenThreshold: 'First-Token Latency',
        firstTokenThresholdSummary: '{observed}s (threshold {threshold}s)',
        firstTokenRatioTrigger: '{slow}/{total} slow requests in {minutes} minutes: {observed}%, reaching the {threshold}% trigger share.',
