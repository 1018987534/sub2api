export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        syncRateHint: 'After each successful probe, update the account rate as upstream declared base rate × conversion ratio. Failed probes or results outside the allowed range leave it unchanged. Enabling this also turns on "Automatically probe upstream declared rate".',
        syncRateManagedHint: 'The current rate is maintained as upstream declared base rate (excluding peak hours) × conversion ratio.',
        rateConversionRatio: 'Upstream Rate Conversion Ratio',
        rateConversionRatioHint: 'Account rate = upstream declared base rate × conversion ratio. For example, an upstream rate of 2x and a ratio of 0.05 produce an account rate of 0.1x.',
