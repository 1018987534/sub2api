export default {
    ...
    dashboard: {
      ...
      firstTokenModel: 'Requested model',
      firstTokenEffort: 'Reasoning effort',
      firstTokenDimension: 'Scheduling dimension',
      firstTokenPrediction: 'Normal total',
      firstTokenPercentiles: 'P50 / P90',
      firstTokenPool: 'Pool',
      firstTokenFastPool: 'Fast',
      firstTokenSlowPool: 'Slow',
      firstTokenCircuitBrokenPool: 'Slow · circuit broken, pending sample',
    ...
    users: {
      ...
      rewardBalanceChange: 'Balance: ${before} → ${after}',
