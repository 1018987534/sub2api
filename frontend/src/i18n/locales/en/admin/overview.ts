export default {
    ...
    users: {
      ...
      reengagement: {
        action: 'Reengage ({count})',
        actionAll: 'Reengage filtered ({count})',
        title: 'Send User Reengagement Email',
        allActivity: 'All usage activity',
        allRechargeStatuses: 'All recharge statuses',
        recharged: 'Recharged',
        notRecharged: 'Never recharged',
        sendScope: 'Send scope',
        selectedScope: 'Selected users ({count})',
        allScope: 'All filtered users ({count})',
        activityLabel: 'Reengagement audience',
        inactiveDays: 'Not used in {days} days',
        neverUsed: 'Never used',
        recipients: 'Selected users',
        template: 'Email template',
        templateName: 'Inactive user reengagement',
        rate: 'Current rate multiplier',
        selectionLimit: 'Select no more than {max} users at a time.',
        send: 'Send emails',
        queueAll: 'Send all in background',
        sending: 'Sending...',
        confirm: 'Send the reengagement email to the {count} selected users? Usage activity, role, and account status will be checked again.',
        confirmAll: 'Start a reengagement campaign for the {count} users in the current filtered result? Eligible active users will be checked again and sent in background batches.',
        backgroundHint: 'All filtered results are processed in background batches beyond the current page. Users already sent today or unsubscribed are skipped automatically.',
        queuedSuccess: 'Background campaign queued for {count} matched users',
        success: 'Reengagement complete: {sent} sent, {skipped} skipped',
        partialFailure: '{count} emails failed. Check SMTP configuration and service logs.',
        failed: 'Failed to send reengagement emails'
      },
      editUser: 'Edit User',
