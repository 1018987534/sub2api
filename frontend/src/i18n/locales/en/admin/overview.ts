export default {
    ...
    dashboard: {
      ...
      firstTokenLatencyTitle: 'Relay Recent Median First Token',
      firstTokenLatencyDescription: 'Only enabled OpenAI API-key relay accounts are included. The value is the median of the latest 9 samples; a slow account needs 3 consecutive samples at or below 10 seconds to enter the fast pool. OAuth accounts are excluded.',
      ...
      firstTokenPrediction: 'Recent median',
