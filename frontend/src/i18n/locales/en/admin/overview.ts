export default {
    ...
    dashboard: {
      ...
      firstTokenLatencyDescription: 'Uses completed, billable streams only. Normal total duration is the average of the configured sample window, falling back to 24-hour data until the primary window has enough samples. The fast pool prefers lower rates; the slow pool prefers shorter duration.',
