export default {
    ...
    dashboard: {
      ...
      firstTokenLatencyTitle: 'Relay Recent Average First Token',
      firstTokenLatencyDescription: 'Only enabled OpenAI API-key relay accounts are included. The value is the arithmetic average from the recent sample window; OAuth accounts are excluded.',
      ...
      firstTokenPrediction: 'Recent average',
