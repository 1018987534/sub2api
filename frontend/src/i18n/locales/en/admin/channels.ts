export default {
    ...
    channels: {
      ...
      upstreamPrice: {
        title: 'Upstream price discrepancy detected',
        description: 'Candidate prices are inferred from actual usage in the last 24 hours. They never affect billing until an administrator reviews and confirms them.',
        account: 'Upstream account',
        model: 'Model',
        current: 'Current billing price',
        inferred: 'Usage-inferred price',
        evidence: 'Evidence',
        input: 'Input',
        output: 'Output',
        ...
        confirmSuccess: 'Candidate price synced for {model}',
        loadError: 'Failed to load upstream price discrepancies',
        confirmError: 'Failed to sync the upstream candidate price',
        source: {
          local: 'Local price table',
          upstream_sync: 'Scheduled upstream snapshot',
          upstream_manual: 'Administrator-confirmed price'
        }
      },
