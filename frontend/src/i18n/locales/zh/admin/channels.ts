export default {
    ...
    channels: {
      ...
      upstreamPrice: {
        title: '发现上游价格差异',
        description: '系统根据最近 24 小时的实际调用明细反推出候选价格。候选价不会自动参与扣费，请核对后手动确认同步。',
        account: '上游账号',
        model: '模型',
        current: '当前计费价格',
        inferred: '实际调用反推价',
        ...
        samples: '{count} 条有效样本',
        confirm: '确认同步',
        confirmSuccess: '已同步 {model} 的候选价格',
        loadError: '加载上游价格差异失败',
        confirmError: '同步上游候选价格失败',
        source: {
          local: '本地价格表',
          upstream_sync: '上游定时快照',
          upstream_manual: '管理员已确认价格'
        }
      },
