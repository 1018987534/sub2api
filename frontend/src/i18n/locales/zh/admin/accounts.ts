export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        syncRate: '同步上游声明倍率',
        syncRateHint: '成功探测后按“上游声明基准倍率 × 折算比例”更新账号倍率；探测失败或结果超出允许范围时保持不变。开启本项会同时打开“自动探测上游声明倍率”。',
        syncRateManagedHint: '当前倍率按“上游声明基准倍率（不含高峰）× 折算比例”自动维护。',
        rateConversionRatio: '上游倍率折算比例',
        rateConversionRatioHint: '账号倍率 = 上游声明基准倍率 × 折算比例。例如上游 2x、折算比例 0.05，最终账号倍率为 0.1x。',
