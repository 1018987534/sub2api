export default {
    ...
    dashboard: {
      ...
      firstTokenLatencyTitle: '上游中转近期中位首字',
      firstTokenLatencyDescription: '仅统计当前启用的 OpenAI API Key 上游账号。数值为最近 9 个样本的中位首字耗时；慢账号需连续 3 次不超过 10 秒才进入快池，不含 OAuth 账号。',
      firstTokenLatencyFailed: '首字统计加载失败',
      firstTokenLatencyEmpty: '当前启用的上游中转账号暂无首字统计',
      firstTokenAccount: '账号',
      firstTokenPrediction: '近期中位首字',
