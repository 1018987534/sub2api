...
export interface SystemSettings {
  ...
  affiliate_min_paid_invitees: number;
  ...
  hide_user_subscriptions_menu: boolean;
  ...
  total_duration_fast_threshold_seconds: number;
  total_duration_slow_threshold_seconds: number;
