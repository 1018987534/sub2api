...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/domain-brand-config", h.Admin.Setting.GetDomainBrandConfig)
		adminSettings.PUT("/domain-brand-config", h.Admin.Setting.UpdateDomainBrandConfig)
