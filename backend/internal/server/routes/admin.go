...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/upstream-billing-price-discrepancies", h.Admin.Account.ListUpstreamBillingPriceDiscrepancies)
		accounts.GET("/ollama-cloud-usage/settings", h.Admin.Account.GetOllamaCloudUsageSettings)
		accounts.PUT("/ollama-cloud-usage/settings", h.Admin.Account.UpdateOllamaCloudUsageSettings)
		accounts.GET("/first-token-latencies", h.Admin.Account.GetFirstTokenLatencies)
		accounts.POST("/:id/first-token-probe", h.Admin.Account.RequestFirstTokenManualProbe)
		...
		accounts.POST("/:id/upstream-billing-price-confirm", h.Admin.Account.ConfirmUpstreamBillingPrice)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// 多节点 Responses 权重与流量自动摘流
		adminSettings.GET("/gateway-routing", h.Admin.Setting.GetGatewayRoutingSettings)
		adminSettings.PUT("/gateway-routing", h.Admin.Setting.UpdateGatewayRoutingSettings)
		// 请求整流器配置
...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/instances", h.Admin.Usage.ListInstances)
...
func registerAffiliateRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	affiliates := admin.Group("/affiliates")
	{
		...
		affiliates.POST("/invites", h.Admin.Affiliate.CreateInviteMatch)
