...
func RegisterGatewayRoutes(
	...
	rootRoute(http.MethodPost, "/responses", bodyLimit, capacityAdmission(responsesHandler))
	rootRoute(http.MethodPost, "/responses/*subpath", bodyLimit, capacityAdmission(guardResponsesSubpath(responsesHandler)))
	rootRoute(http.MethodPost, "/alpha/search", textBodyLimit, h.OpenAIGateway.AlphaSearch)
	rootRoute(http.MethodGet, "/responses", bodyLimit, capacityAdmission(func(c *gin.Context) {
		h.OpenAIGateway.ResponsesWebSocket(c)
	}))
