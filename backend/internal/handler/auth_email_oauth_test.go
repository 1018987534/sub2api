...
func (r *oauthEmailAffiliateRepoStub) BindInviter(_ context.Context, userID, inviterID int64, _ service.AffiliateBindingSource) (bool, error) {
...
func (r *oauthEmailAffiliateRepoStub) TransferQuotaToBalance(context.Context, int64, int, time.Time) (float64, float64, error) {
