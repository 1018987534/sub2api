...
func TestSettingHandler_UpdateSettings_PersistsPaymentVisibleMethodsAndAdvancedScheduler(t *testing.T) {
	...
	require.Equal(t, "true", repo.values[service.SettingKeyOpenAILowUpstreamRateStickyWeightedEnabled])
	...
	require.Equal(t, true, data["openai_low_upstream_rate_sticky_weighted_enabled"])
