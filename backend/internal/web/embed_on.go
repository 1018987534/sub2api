...
func (s *FrontendServer) serveIndexHTML(c *gin.Context) {
	...
	// Cache is scoped by normalized host because injected branding can vary by
	// domain while all domains are served by the same binary.
	host := normalizeHTMLCacheHost(c.Request.Host)
	cached := s.cache.Get(host)
	if cached != nil {
	...
	s.cache.Set(host, rendered, settingsJSON)
...
func normalizeHTMLCacheHost(raw string) string {
