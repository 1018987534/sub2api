...
func TestTotalLatencyStatsCacheRecentMinutePlusSamplesDoNotResetHistory(t *testing.T) {
...
func TestTotalLatencyStatsCacheThreeThreeMinuteRequestsBreakAffinity(t *testing.T) {
	...
	require.False(t, mr.Exists(probeKey), "completed samples release probe leases")
