...
const (
	...
	AffiliateMinPaidInviteesDefault     = 5     // 至少 5 个不同邀请用户成功支付后才能转余额
	AffiliateMinPaidInviteesMax         = 10000
...
const (
	...
	RedeemTypeLotteryReward    = "lottery_reward"
)
...
const (
	...
	SettingKeyPasswordResetEnabled                = "password_reset_enabled"           // 是否启用忘记密码功能
	...
	SettingKeyAffiliateMinPaidInvitees            = "affiliate_min_paid_invitees"      // 转余额所需的最少成功支付邀请人数（0=不限制）
	...
	SettingKeyHideUserSubscriptionsMenu   = "hide_user_subscriptions_menu"  // 是否隐藏用户侧“我的订阅”菜单入口
	...
	// SettingKeyLotteryEnabled is the opt-in user menu and API switch.
	...
	// SettingKeyTotalDurationPriorityEnabled controls total-duration fast/slow
