...
const (
	...
	// The special-price route is reserved for accounts whose confirmed normal
	// duration is at most 13 seconds. Accounts above this boundary stay in the
	// slow pool even if an older Redis membership flag still says fast.
