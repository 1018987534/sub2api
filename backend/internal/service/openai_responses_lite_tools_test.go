...
func TestNormalizeOpenAIResponsesLiteTools_DoesNotChangeParallelCallsWithoutTools(t *testing.T) {
	reqBody := map[string]any{
		"reasoning":           map[string]any{"context": "all_turns"},
		"parallel_tool_calls": true,
	}
...
func TestNormalizeOpenAIResponsesLiteTools_RejectsNonBooleanParallelCalls(t *testing.T) {
	reqBody := map[string]any{
		"tools":               []any{map[string]any{"type": "function", "name": "shell"}},
...
func TestNormalizeOpenAIResponsesLiteTools_ParallelCallsIsIdempotent(t *testing.T) {
	reqBody := map[string]any{
		"reasoning":           map[string]any{"context": "all_turns"},
		"tools":               []any{map[string]any{"type": "function", "name": "shell"}},
		"parallel_tool_calls": true,
