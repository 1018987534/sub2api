...
func (s *OpenAIGatewayService) ForwardImages(
	...
	if shouldSplitOpenAIImagesRequest(account, parsed, channelMappedModel) {
...
func shouldSplitOpenAIImagesRequest(account *Account, parsed *OpenAIImagesRequest, channelMappedModel string) bool {
	if account == nil || account.Type != AccountTypeOAuth || !isOpenAIImagesMultiOutputRequest(parsed) {
		return false
	}
	...
	return !usesCodexDirectImages(account.GetMappedModel(requestModel))
}
