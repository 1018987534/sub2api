...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	channelService := service.ProvideChannelService(channelRepository, groupRepository, apiKeyAuthCacheInvalidator, pricingService, usageLogRepository)
	...
	modelPlazaService := service.ProvideModelPlazaService(channelRepository, groupRepository, pricingService, billingService, modelPricingResolver, usageLogRepository)
	channelMonitorUserHandler := handler.NewChannelMonitorUserHandler(channelMonitorService, modelPlazaService, settingService)
