...
func init() {
	...
	// apikeyDescGroupRoutes is the schema descriptor for group_routes field.
	apikeyDescGroupRoutes := apikeyFields[4].Descriptor()
	// apikey.DefaultGroupRoutes holds the default value on creation for the group_routes field.
	apikey.DefaultGroupRoutes = apikeyDescGroupRoutes.Default.([]domain.APIKeyGroupRoute)
	...
	// usagelogDescInstanceID is the schema descriptor for instance_id field.
	usagelogDescInstanceID := usagelogFields[36].Descriptor()
	// usagelog.InstanceIDValidator is a validator for the "instance_id" field. It is called by the builders before save.
	usagelog.InstanceIDValidator = usagelogDescInstanceID.Validators[0].(func(string) error)
