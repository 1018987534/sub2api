...
func init() {
	...
	// userDescRegistrationSiteName is the schema descriptor for registration_site_name field.
	userDescRegistrationSiteName := userFields[13].Descriptor()
	// user.DefaultRegistrationSiteName holds the default value on creation for the registration_site_name field.
	user.DefaultRegistrationSiteName = userDescRegistrationSiteName.Default.(string)
