...
var (
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "sort_order", Type: field.TypeInt, Default: 1000000},
	...
	ChannelMonitorsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "channelmonitor_sort_order_id",
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorsColumns[14], ChannelMonitorsColumns[0]},
			},
			{
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "min_cache_rate", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	}
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "instance_id", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "image_count", Type: field.TypeInt, Default: 0},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_instance_id_created_at",
				Unique:  false,
